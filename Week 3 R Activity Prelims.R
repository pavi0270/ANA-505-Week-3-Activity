...
weightcolumn <- new_womendata[, c("weight")]
...
heightcolumn <- new_womendata[, c("height")]
...
newdf <- data.frame(heightcolumn,weightcolumn)
...
ggplot(new_womendata, aes(x=height, y=weight)) + 
  geom_point()
